...
const { FindTest, InsertTest, ForeignTest, UpdateTest } = require('../controllers');

const ObjFindTest = new FindTest()
const ObjInsertTest = new InsertTest()
const ObjForeignTest = new ForeignTest()
const ObjUpdateTest = new UpdateTest()
...
router.get('/find/fk/:order_id', async (req, res) => { await ObjForeignTest.__find_fk_( req, res ) })
...
router.put('/update/customer', async( req, res ) => { await ObjUpdateTest.__update_customer_(req, res) })
router.put('/update/order', async (req, res) => { await ObjUpdateTest.__update_order_(req, res) })
